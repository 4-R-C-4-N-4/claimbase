"""
llm.py — Shared LLM provider abstraction.

VENDORED VERBATIM from guru/scripts/llm.py (2026-08-08). guru is upstream; fix
bugs there and re-copy rather than diverging here. Vendored rather than imported
because claimbase is a separate repo and should not depend on guru's layout — but
rewriting it would have been the mistake the plan warns against, since this module
already encodes hard-won policy (max_tokens required, thinking-model handling).
